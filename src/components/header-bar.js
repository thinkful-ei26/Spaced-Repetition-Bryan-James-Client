...
export class HeaderBar extends React.Component {
  ...
  render() {
    ...
    let easyBtn;
    // let hamburgerBtn
    let loginBtn = (<li><Link to='/login' className='waves-effect waves-light btn'>Login</Link></li>)
    let registerBtn = (<li><Link to='/register' className='waves-effect waves-light btn'>Register</Link></li>)
    let trialBtn = (<li><Link to='/trial' className='waves-effect waves-light btn'>Trial</Link></li>)
    if (this.props.loggedIn) {
      logOutButton = <Link to='/logout' className="waves-effect waves-light btn">Log Out</Link>
      // logOutButton = <button className='logoutBtn' onClick={() => this.logOut()}>Log out</button>;
      easyBtn = <a className='waves-effect waves-light btn resetBtn' onClick={() => this.resetQuestions()}>Reset Questions</a>;
