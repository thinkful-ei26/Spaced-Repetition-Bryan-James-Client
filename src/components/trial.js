...
export default class Trial extends Component {
  ...
  render() {
    let lessons = ["A Python data type that holds an ordered collection of values, which can be of any type. This is equivalant to an array in many other languages. Python lists are mutable, implying that they can be changed once created.",
     ...
     (<div>Python builds functions using the syntax:<code className=''> def function_name(variable): </code>Functions can be stand-alone or can return values. Functions can also contain other functions.</div>),
    ...
    return (
      <div className="trial link">
        ...
        <p className='lessonsText'>{lessons[this.state.currentLesson]}</p>
